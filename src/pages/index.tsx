  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Sharing Application: Empowering you to build and share your journey, one ride at a time. Your adventure starts here."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Sharing Application: Empowering you to build and share your journey, one ride at a time. Your adventure starts here.`}
            </Text>
            <Box
